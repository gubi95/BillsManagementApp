...
public class CreateBillEntries {
    ...
    public String getTableBillEntries(){
        return "CREATE TABLE " + TABLE_BILLENTRIES + "("
                ...
                + "FOREIGN KEY("+COLUMN_CATEGORY_PRODUCTCATEGORYID+") REFERENCED "+TABLE_PRODUCTCATEGORIES+"("+COLUMN_PRODUCTCATEGORYID+")"
                + "FOREIGN KEY("+COLUMN_BILL_BILLID+") REFERENCED "+TABLE_BILLS+"("+COLUMN_BILLID+")"
                +")";
    }
}
